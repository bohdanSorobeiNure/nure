...
to move-s
  let nearby-wolves wolves in-radius 7  ;  змінна, що містить список вовків у радіусі 1 одиниці від вівці
  ifelse any? wolves in-radius 7        ;  Перевірка, чи є вовки в радіусі 1
  [
